...
import com.xx.model.dto.userinterfaceinfo.UserInterfaceInfoAddRequest;
import com.xx.model.dto.userinterfaceinfo.UserInterfaceInfoQueryRequest;
import com.xx.model.dto.userinterfaceinfo.UserInterfaceInfoUpdateRequest;
...
public class UserInterfaceInfoController {
    ...
    public BaseResponse<Long> addUserInterfaceInfo(@RequestBody UserInterfaceInfoAddRequest userInterfaceInfoAddRequest, HttpServletRequest request) {
        ...
        // 使用BeanUtils.copyProperties方法将userInterfaceInfoAddRequest对象的属性复制到userInterfaceInfo对象中。这是一种常用的属性复制方法，用于将一个对象的属性值复制到另一个对象。
