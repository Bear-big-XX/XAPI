package com.xx.xagentsdk.client;
...
import static com.xx.xagentsdk.utils.SignUtils.genSign;
...
//        map.put("secretKey",secretKey);
    ...
    public String getNameByGet(String name){
        ...
        String result = HttpUtil.get(GATEWAY_HOST + "/xapi/name/",paraMap);
        // 打印服务器返回的结果
    ...
    public String getNameByPost(String name){
        ...
        String result = HttpUtil.post(GATEWAY_HOST + "/xapi/name/",paraMap);
        // 打印服务器返回的结果
        System.out.println(result);
        return result;
    }
    ...
    public String getUserNameByPost(User user){
       // 将user对象转换为JSON字符串
        ...
        HttpResponse httpResponse = HttpRequest.post(GATEWAY_HOST + "/xapi/name/12")
                // 添加构造的请求头
